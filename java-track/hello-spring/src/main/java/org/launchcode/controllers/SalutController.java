...
public class SalutController {
		...
		@RequestMapping(value="/salut",method=RequestMethod.POST)//all incoming POST requests to this url will be handled in this function
		...
		public String hello(HttpServletRequest request, Model model){//input parameter takes Spring's special class that represents an http request as a java class 
			...
			return "salut"; //hello is the name of the template in current directory
